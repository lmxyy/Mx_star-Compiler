...
public class NASMRegisterSet {
    ...
    public static NASMRegister RCX = new NASMRegister(0,"rcx","cl",true,true,false,true);
    ...
    public static NASMRegister R9 = new NASMRegister(0,"r9","r9b",true,true,false,true);
