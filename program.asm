...
___getHash:
___getHash..getHash.entry:
	push rbp
	mov rbp,rsp
	sub rsp,112
	mov qword [rbp-32],rdi
	mov r8,qword [___hashsize]
	mov qword [rbp-40],r8
	mov r8,qword [rbp-32]
	mov r9,r8
	mov qword [rbp-16],r9
...
___put..while_cond:
	...
	cmp r8b,1
	jz ___put..while_loop
	jnz ___put..while_after
___put..while_loop:
	mov r8,qword [rbp-40]
	mov r9,qword [r8+16]
...
___get..while_cond:
	...
	mov r8,qword [rbp-80]
	cmp r8b,1
	jz ___get..while_loop
	jnz ___get..while_after
___get..while_loop:
	mov r8,qword [rbp-40]
	mov r9,qword [r8+16]
	mov qword [rbp-64],r9
